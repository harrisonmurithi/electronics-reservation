...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li class="active"><a href="products_alcatel_tablets.php"><font color="#000000">Tablets</font></a></li>
...
$result= mysqli_query($con,"select * from products where product_brand='Alcatel' and product_type='Tablets' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
