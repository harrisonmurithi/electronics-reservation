...
<caption><div class="pagination">
  ...
  <ul>
    <li class="active"><a href="products_samsung.php"><font color="#000000">All</font></a></li>
...
$result= mysqli_query($con,"select * from products where product_brand='Samsung' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
