...
$result= mysqli_query($con,"select * from products where product_type='Smart Products'  and product_status='Available' order by product_id ASC") or die (mysqli_error());
...
?>
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tab">
						...
						<br />
						<br />
									<p class="desc" style="text-align:center; word-wrap:break-word; word-spacing:1px;"> 
