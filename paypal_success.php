...
<?php 
		...
		echo "<a href='hudutech_e-hardware/customer/my_account.php'>Go to your Account</a>";
		
		}
		else {
		
		echo "<h2>Welcome Guest, Payment failed</h2><br>";
		echo "<a href='hudutech_e-hardware'>Go to Back to shop</a>";
			...
			$headers .= 'From: <sales@e-hardware.com>' . "\r\n";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website e-hardware.com, please find your order details, your order will be processed shortly. Thank you!</p>
			
				<table width='600' align='center' bgcolor='#FFCC99' border='2'>
			
					<tr align='center'><td colspan='6'><h2>Your Order Details from e-hardware.com</h2></td></tr>
				...
				<h2> <a href='hudutech_e-hardware'>Click here</a> to login to your account</h2>
				
				<h3> Thank you for your order @ - www.e-hardware.com</h3>
