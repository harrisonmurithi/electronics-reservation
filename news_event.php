...
<!--script-->
      ...
      <div id="content">
				<div id="table">
					...
					<h2 style="color:#f6132e; font-size:25px; margin-bottom:-7px;">k24 Electronics Open Day. The Digital World! (2/9/2016)</h2>
						<hr>
						<p>
						...
						<p style="color:#333333; font-size:18px;">
						As of today, we have 26 branches in Kenya in the major cities.
