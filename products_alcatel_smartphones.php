...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li class="active"><a href="products_alcatel_smartphones.php"><font color="#000000">Smartphones</font></a></li>
...
$result= mysqli_query($con,"select * from products where product_brand='Alcatel' and product_type='Smartphones' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
