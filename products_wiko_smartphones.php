...
<div class="hero-unit-3">
			<h4 style="color:#0000ff;">Cellphones Brand:<b>&nbsp;Wiko</b></h4>
<br />
<br />
<!--- table -->
<table style="width:100%; margin:auto;" class="table table-hover table-striped" id="example">
<caption><div class="pagination">
			<h5 style=" margin-right: 270px;">Wiko Products</h5>
  <ul>
    <li><a href="products_wiko.php"><font color="#000000">All</font></a></li>
    <li><a href="products_wiko_phones.php"><font color="#000000">Phones</font></a></li>
    <li class="active"><a href="products_wiko_smartphones.php"><font color="#000000">Smartphones</font></a></li>
    <li><a href="products_wiko_tablets.php"><font color="#000000">Tablets</font></a></li>
    <li><a href="products_wiko_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='Wiko' and product_type='Smartphones' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
