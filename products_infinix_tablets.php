...
<caption><div class="pagination">
  ...
  <ul>
    <li><a href="products_cherry.php"><font color="#000000">All</font></a></li>
    <li><a href="products_cherry_phones.php"><font color="#000000">Phones</font></a></li>
    <li><a href="products_cherry_smartphones.php"><font color="#000000">Smartphones</font></a></li>
    <li class="active"><a href="products_cherry_tablets.php"><font color="#000000">Tablets</font></a></li>
    <li><a href="products_cherry_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='Infinix' and product_type='Tablets' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
