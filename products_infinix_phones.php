...
<caption><div class="pagination">
  ...
  <ul>
    <li><a href="infinix_cherry.php"><font color="#000000">All</font></a></li>
    <li class="active"><a href="products_infinix_phones.php"><font color="#000000">Phones</font></a></li>
...
$result= mysqli_query($con,"select * from products where product_brand='infinix' and product_type='Phones' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
