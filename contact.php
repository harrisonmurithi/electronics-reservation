...
mysqli_query($con,"INSERT INTO feedback (feedback_firstname,feedback_lastname,feedback_email,feedback_number,feedback_message,date_published)
VALUES ('$feedback_firstname','$feedback_lastname','$feedback_email','$feedback_number','$feedback_message',NOW())") or die(mysqli_error());
