...
$result= mysqli_query($con,"select * from products where product_brand='Alcatel' and product_type='Accessories' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
