...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li class="active"><a href="products_nokia_phones.php"><font color="#000000">Phones</font></a></li>
...
$result= mysqli_query("select * from products where product_brand='Nokia' and product_type='Phones' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
