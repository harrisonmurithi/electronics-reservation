...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li class="active"><a href="products_samsung_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='Samsung' and product_type='Accessories' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
