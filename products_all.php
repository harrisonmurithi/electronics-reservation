    ...
    <div id="header" style="width: 1157px; margin-left: 29px;">
      ...
      <div id="menubar" style="width: 1157px; margin-left: 1px;">
        <ul id="menu">
          ...
          <li><a href="news_event.php">News and Event</a></li><li><div class="dropdown">
...
<caption><div class="pagination">
			<h5 style=" margin-right: 270px;">All Products</h5>
  <ul>
    <li class="active"><a href="products_all.php"><font color="#000000">All</font></a></li>
    <li class="active"><a href="products_alcatel.php"><font color="#000000">Alcatel</font></a></li>
    <li><a href="products_samsung.php"><font color="#000000">Samsung</font></a></li>
    <li><a href="products_nokia.php"><font color="#000000">Nokia</font></a></li>
    <li><a href="products_wiko.php"><font color="#000000">Wiko</font></a></li>
    <li><a href="products_infinix.php"><font color="#000000">Infinix</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_status='Available' order by product_id ASC ") or die (mysqli_error());
