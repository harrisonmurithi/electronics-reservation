...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="supplier_alcatel.php"><font color="#000000">Alcatel</font></a></li>
...
<tbody>
<?php
$result= mysqli_query($con,"select * from suppliers where supplier_company_name='Alcatel' ") or die (mysqli_error());
