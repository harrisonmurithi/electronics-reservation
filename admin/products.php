...
<form method="post" enctype="multipart/form-data">
	<table class="product_table" cellspacing="5" cellpadding="5">
		...
		<tr>
			...
			<td width="50px"></td>
			<td><input type="number"  name="number" placeholder="supplier Number..." required />
			</td>
		</tr>
                <tr>
			<td><label>Reserve Fee</label></td>
			<td width="50px"></td>
			<td><input type="number"  name="reservefee" placeholder="supplier Number..." required />
			</td>
		</tr>
		<tr>
...
$result= mysqli_query($con,"select * from products order by product_type DESC") or die (mysqli_error());
