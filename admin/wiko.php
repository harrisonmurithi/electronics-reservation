...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="wiko.php"><font color="#000000">Wiko</a></font></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='Wiko' ") or die (mysqli_error());
