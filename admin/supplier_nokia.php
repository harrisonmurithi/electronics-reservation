...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="supplier_nokia.php"><font color="#000000">Nokia</font></a></li>
...
<tbody>
<?php
$result= mysqli_query($con,"select * from suppliers where supplier_company_name='Nokia' ") or die (mysqli_error());
