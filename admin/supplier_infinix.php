...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="supplier_infinix.php"><font color="#000000">Infinix</font></a></li>
    <li ><a href="supplier_wiko.php"><font color="#000000">Wiko</a></font></li>
  </ul>
</div></caption>
...
<tbody>
<?php
$result= mysqli_query($con,"select * from suppliers where supplier_company_name='Infinix' ") or die (mysqli_error());
