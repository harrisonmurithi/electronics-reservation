...
<form method="post" enctype="multipart/form-data">
	<table class="product_table" cellspacing="5" cellpadding="5">
		...
		<tr>
			...
			<td width="50px"></td>
			<td><input type="number"  name="supplier_id" placeholder="supplier Number..." required />
			</td>
		</tr>
		<tr>
...
<?php
	include('includes/db.php');
							...
							if ($error > 0){
									...
									mySQLi_query($con,"INSERT INTO products (product_name,product_brand,product_description,product_price,supplier_id,product_status,date_added,location) 
									VALUES ('$product_name','$product_brand','$product_description','$product_price','$supplier_id','$product_status',NOW(),'$location')") or die(mysqli_error());
									}
...
$result= mysqli_query($con,"select * from products where product_brand='Samsung' ") or die (mysqli_error());
