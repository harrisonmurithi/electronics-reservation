...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="alcatel.php"><font color="#000000">Alcatel</font></a></li>
...
$result= mysqli_query($con,"select * from products where product_brand='Alcatel' ") or die (mysqli_error());
