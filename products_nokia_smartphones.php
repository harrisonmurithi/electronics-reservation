...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li class="active"><a href="products_nokia_smartphones.php"><font color="#000000">Smartphones</font></a></li>
    <li><a href="products_nokia_tablets.php"><font color="#000000">Tablets</font></a></li>
    <li><a href="products_nokia_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='Nokia' and product_type='Smartphones' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
