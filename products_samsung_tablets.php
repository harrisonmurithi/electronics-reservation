...
$result= mysqli_query($con,"select * from products where product_brand='Samsung' and product_type='Tablets' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
