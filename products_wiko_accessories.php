...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li><a href="products_wiko_smartphones.php"><font color="#000000">Smartphones</font></a></li>
    <li><a href="products_wiko_tablets.php"><font color="#000000">Tablets</font></a></li>
    <li class="active"><a href="products_wiko_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='wiko' and product_type='Accessories' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
