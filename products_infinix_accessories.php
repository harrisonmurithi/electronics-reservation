...
<div class="hero-unit-3">
			<h4 style="color:#0000ff;">Cellphones Brand:<b>&nbsp;Infinix Mobile</b></h4>
<br />
<br />
<!--- table -->
<table style="width:100%; margin:auto;" class="table table-hover table-striped" id="example">
<caption><div class="pagination">
			<h5 style=" margin-right: 240px;">Infinix Mobile Products</h5>
  <ul>
    <li><a href="products_infinix.php"><font color="#000000">All</font></a></li>
    <li><a href="products_infinix_phones.php"><font color="#000000">Phones</font></a></li>
    <li><a href="products_infinix_smartphones.php"><font color="#000000">Smartphones</font></a></li>
    <li><a href="products_infinix_tablets.php"><font color="#000000">Tablets</font></a></li>
    <li class="active"><a href="products_infinix_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysqli_query($con,"select * from products where product_brand='Infinix' and product_type='Accessories' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
