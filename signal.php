...
<!--script-->
	  ...
	  <div id="sidebar_container">
		...
		<div class="side_bar">	
			<a href="signal.php" class="sidebar_menu_active"><img src="images/icon/cgnal.png" width="33" alt="Phones">&nbsp;&nbsp;Signal HD TV</a>
		</div>
          </div>
        </div>
...
$result= mysqli_query($con,"select * from products where product_type='Cignal HD TV'  and product_status='Available' order by product_id ASC") or die (mysqli_error());
...
?>
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tab">
						...
						<br />
									...
									<center>		
										<span class="prices">
											Ksh <?php $oprice=$row['product_price']; echo formatMoney($oprice, true);?>
										</span>									
						<br />
						<br />												
