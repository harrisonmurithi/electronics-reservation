...
<caption><div class="pagination">
  ...
  <ul>
    <li class="active"><a href="products_wiko.php"><font color="#000000">All</font></a></li>
    <li><a href="products_wiko.php"><font color="#000000">Phones</font></a></li>
...
$result= mysqli_query($con,"select * from products where product_brand='wiko' and product_status='Available' order by product_id ASC ") or die (mysqli_error());
